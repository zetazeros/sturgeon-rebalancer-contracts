...
import { SturgeonOracle } from "../types";
...
contract<SturgeonOracle, DeployOptions, CustomContext>(
    "SturgeonOracle",
    function () {
        const deploySturgeonOracle = async (options: DeployOptions) => {
            ...
            this.subject = await ethers.getContract("SturgeonOracle");
        };

        before(async () => {
            this.deploymentFixture = deployments.createFixture(
                async (_, options?: DeployOptions) => {
                    await deploySturgeonOracle(
        ...
        describe("#contructor", () => {
            ...
            it("initializes name", async () => {
                expect("SturgeonOracle").to.be.eq(
        ...
        describe("#price", () => {
            ...
            const tests: TestParameters[] = [
                ...
                },
                {
                    ...
                    name: "when SturgeonOracle is initialized",
                    size: 6,
                    mask: 127,
                },
            ];
            ...
            tests.forEach((params) => {
                describe(params.name, () => {
                    it("returns prices", async () => {
                        await deploySturgeonOracle(params.opts);
            ...
            describe("edge cases:", () => {
                describe("when one of tokens is zero", () => {
                    it("does not return prices", async () => {
                        await deploySturgeonOracle(DEFAULT_DEPLOY_PARAMS);
